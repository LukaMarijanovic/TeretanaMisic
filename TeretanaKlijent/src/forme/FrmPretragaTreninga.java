 ...
 */
public class FrmPretragaTreninga extends javax.swing.JFrame {

    /**
     * Creates new form FrmPretragaTreninga
     */
    public FrmPretragaTreninga() {
        initComponents();
        Komunikacija.getInstance().setFrmPretragaTreninga(this);
        popuniTabeluTrening();
    }
    ...
    private void jButtonPretraziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPretraziActionPerformed
        ...
        try {
            ...
            if(kriterijum.isEmpty()){
                ...
                List<OpstiDomenskiObjekat> lista = Komunikacija.getInstance().pretraziTreninge(kriterijum);
                if(!lista.isEmpty()){
                    postaviModelTabele(lista);
                    prikaziPorukuObavestenja("Sistem je pronašao treninge po zadatoj vrednosti");
                }else{
                    postaviModelTabele(new ArrayList<OpstiDomenskiObjekat>());
                    prikaziPorukuGreske("Sistem ne može da pronađe treninge po zadatoj vrednosti");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jButtonDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDetaljiActionPerformed
        // TODO add your handling code here:
        preuzmiSelektovaniTrening(Konstante.SK_PRIKAZ);
    }//GEN-LAST:event_jButtonDetaljiActionPerformed

    private void jButtonIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIzmeniActionPerformed
        // TODO add your handling code here:
        preuzmiSelektovaniTrening(Konstante.SK_IZMENA);
    ...
    private void jButtonObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonObrisiActionPerformed
        ...
        if(red != -1){
            try {
                ...
                Trening trening = ((ModelTabeleTrening)jTableTrening.getModel()).vratiTrening(red);
                Komunikacija.getInstance().obrisiTrening(trening.getTreningID()+"");
                prikaziPorukuObavestenja("Sistem je uspešno obrisao trening");
                osvezi();

            } catch (Exception e) {
                e.printStackTrace();
                prikaziPorukuGreske("Sistem ne može da obriše trening");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPretragaTreninga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
private void popuniTabeluTrening() {
        try {
            List<OpstiDomenskiObjekat> lista = Komunikacija.getInstance().vratiTreninge();
            postaviModelTabele(lista);
        } catch (Exception ex) {
            prikaziPorukuGreske("Problem pri ucitavanju treninga");
        }
    }

    private void postaviModelTabele(List<OpstiDomenskiObjekat> lista) {
        jTableTrening.setModel(new ModelTabeleTrening(lista));
    }
    ...
    private void preuzmiSelektovaniTrening(int sk) {
        int red = jTableTrening.getSelectedRow();
        
        if(red != -1){
            try {
                Trening izabraniTrening = ((ModelTabeleTrening) jTableTrening.getModel()).vratiTrening(red);
                List<OpstiDomenskiObjekat> lista = Komunikacija.getInstance().pretraziTreninge(izabraniTrening.getTreningID()+"");
                
                if(!lista.isEmpty()){
                    prikaziPorukuObavestenja("Sistem je uspešno učitao podatke o treningu");
                    Trening trening = (Trening) lista.get(0);
                    Komunikacija.getInstance().setTrening(trening);
                    Komunikacija.getInstance().setAktivan_sk(sk);
                    new FrmUnosTreninga(trening).setVisible(true);
                }else{
                    prikaziPorukuGreske("Sistem ne može da učita podatke o treningu");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        }else{
            prikaziPorukuGreske("Niste selektovali trening");
        }
    }
